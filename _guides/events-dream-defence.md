...
- Run `!encounter <tier>` (e.g., `!encounter 3`) in 🤖dm-bot-spam to generate monsters, tokens, stat blocks, and maps
- You may adjust outcomes, but use Monster Manual monsters only; ask in 🏹game-discussion for a sanity check
...
- Get approval in 💎rewards-discussion (link or screenshot), then log in 📈game-reward-log

---

See also: [DM Info]({{ '/guides/dm-info.html' | relative_url }}) for general DM process, posting, and rewards guidance.
